  ...
  return (
    <section ref={ref} className="py-10 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 items-center">
        ...
        >
          <h2 className="text-5xl md:text-6xl luxurious-script-regular text-[#2C2C2C] mb-6">
          ...
          <div className='flex flex-col w-full lg:w-1/2 bg-[#24384b] px-15 pt-20 pb-8 justify-center items-center gap-2'>
            <h1 className='playfair-display-main uppercase text-white text-[15px]'>Ser&aacute; un honor contar con tu presencia</h1>
            <p className='luxurious-script-regular text-white text-[30px]'>¡Te Esperamos!</p>
            <motion.button
              onClick={handleRSVP}
              ...
              whileTap={{ scale: 0.95 }}
              className="w-2/3 items-center gap-3 bg-[#8B7355] text-white py-1 rounded-xl text-md playfair-display-main tracking-[.15em] uppercase hover:bg-[#6F5A42] transition-all shadow-xl hover:shadow-2xl"
            >
              Confirmar
            </motion.button>
          </div>
